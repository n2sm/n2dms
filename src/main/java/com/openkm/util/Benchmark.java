...
public class Benchmark {
     ...
     */
    public void okmApiHighPopulate(String token, Folder root, PrintWriter out, PrintWriter res) throws IOException, InputMismatchException,
            ItemExistsException, PathNotFoundException, UserQuotaExceededException, AccessDeniedException, UnsupportedMimeTypeException,
            FileSizeExceededException, VirusDetectedException, RepositoryException, DatabaseException, ExtensionException,
            AutomationException {
     ...
     * Helper
     */
    private void okmApiHighPopulateHelper(String token, Folder root, PrintWriter out, PrintWriter res, Generator gen, int depth)
            throws InputMismatchException, IOException, ItemExistsException, PathNotFoundException, UserQuotaExceededException,
            AccessDeniedException, UnsupportedMimeTypeException, FileSizeExceededException, VirusDetectedException, RepositoryException,
     ...
     * Run OpenKM text document insertions (API)
     */
    public void okmApiLowPopulate(Session session, Node root, PrintWriter out, PrintWriter res) throws javax.jcr.ItemExistsException,
            javax.jcr.PathNotFoundException, javax.jcr.nodetype.NoSuchNodeTypeException, javax.jcr.lock.LockException,
            javax.jcr.version.VersionException, javax.jcr.nodetype.ConstraintViolationException, javax.jcr.RepositoryException,
            InputMismatchException, IOException, DatabaseException, UserQuotaExceededException {
        long begin = System.currentTimeMillis();
     ...
     * Helper
     */
    private void okmApiLowPopulateHelper(Session session, Node root, PrintWriter out, PrintWriter res, Generator gen, int depth)
            throws javax.jcr.ItemExistsException, javax.jcr.PathNotFoundException, javax.jcr.nodetype.NoSuchNodeTypeException,
            javax.jcr.lock.LockException, javax.jcr.version.VersionException, javax.jcr.nodetype.ConstraintViolationException,
            javax.jcr.RepositoryException, InputMismatchException, IOException, DatabaseException, UserQuotaExceededException {
        ...
        if (depth < maxDepth) {
            for (int i = 0; i < maxFolders; i++) {
                ...
                for (int j = 0; j < maxDocuments; j++) {
                    ...
                    // Repository insertion
                    ByteArrayInputStream bais = new ByteArrayInputStream(baos.toByteArray());
                    BaseDocumentModule.create(session, fld, System.currentTimeMillis() + ".txt", null, "text/plain", new String[] {}, bais);
                    IOUtils.closeQuietly(bais);
                    totalDocuments++;
                }
     ...
     */
    public void okmRawPopulate(Session session, Node root, PrintWriter out, PrintWriter res) throws javax.jcr.ItemExistsException,
            javax.jcr.PathNotFoundException, javax.jcr.nodetype.NoSuchNodeTypeException, javax.jcr.lock.LockException,
            javax.jcr.version.VersionException, javax.jcr.nodetype.ConstraintViolationException, javax.jcr.RepositoryException,
     ...
     * Helper
     */
    private void okmRawPopulateHelper(Session session, Node root, PrintWriter out, PrintWriter res, Generator gen, int depth)
            throws javax.jcr.ItemExistsException, javax.jcr.PathNotFoundException, javax.jcr.nodetype.NoSuchNodeTypeException,
            javax.jcr.lock.LockException, javax.jcr.version.VersionException, javax.jcr.nodetype.ConstraintViolationException,
     ...
     * Helper
     */
    private void jcrPopulateHelper(Session session, Node root, PrintWriter out, PrintWriter res, Generator gen, int depth)
            throws javax.jcr.ItemExistsException, javax.jcr.PathNotFoundException, javax.jcr.nodetype.NoSuchNodeTypeException,
            javax.jcr.lock.LockException, javax.jcr.version.VersionException, javax.jcr.nodetype.ConstraintViolationException,
            javax.jcr.RepositoryException, InputMismatchException, IOException {
     ...
     * Helper
     */
    private void filesystemDocumentGenerateHelper(File root, Generator gen, int depth, long begin) throws InputMismatchException,
            IOException, ItemExistsException, PathNotFoundException, UserQuotaExceededException, AccessDeniedException,
            UnsupportedMimeTypeException, FileSizeExceededException, VirusDetectedException, RepositoryException, DatabaseException,
        ...
        if (depth < maxDepth) {
            for (int i = 0; i < maxFolders; i++) {
                ...
                long end = System.currentTimeMillis();
                String elapse = FormatUtil.formatSeconds(end - begin);
                log.info("Elapse Time: {} - Folders: {}, Documents: {}, Size: {}", new Object[] { elapse, totalFolders, totalDocuments,
                        FormatUtil.formatSize(totalSize) });
