...
public class RepositoryImporter {
     ...
     * Import mail.
     */
    private static ImpExpStats importMail(String token, String fldPath, String fileName, File fDoc, boolean metadata, Writer out,
            InfoDecorator deco) throws IOException, PathNotFoundException, AccessDeniedException, RepositoryException, DatabaseException,
