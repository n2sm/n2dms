...
public class Populate {
    ...
    public static void massiveImport(final String token, final String seedWord, final int numDocs, final List<String> fileTypes, Writer out)
            throws Exception {
            ...
            while (n < numDocs * (typeIdx + 1) / fileTypes.size()) {
                ...
                for (int i = 0; i < urls.length; i++) {
                    ...
                    final String fileName =
                            URLDecoder.decode((String) folderNames.remove(folderNames.size() - 1), "UTF-8").replaceAll(":", "_");
