    ...
    public Object[] patchApply(LinkedList<Patch> patches, String text) {
        ...
        for (Patch aPatch : patches) {
            ...
            if (text1.length() > this.matchMaxBits) {
                ...
                if (start_loc != -1) {
                    end_loc =
                            matchMain(text, text1.substring(text1.length() - this.matchMaxBits), expected_loc + text1.length()
                                    - this.matchMaxBits);
            ...
            if (start_loc == -1) {
                ...
                if (text1.equals(text2)) {
                    ...
                    if (text1.length() > this.matchMaxBits && diffLevenshtein(diffs) / (float) text1.length() > this.patchDeleteThreshold) {
