...
public class ClassLoaderUtils {
     ...
     */
    public static Object invokeMainMethodFromClass(final String className,
            final String[] args, final ClassLoader classLoader)
     ...
     */
    public static Object invokeMethodFromClass(final String className,
    ...
    public static Object invokeMethodFromClass(final String className,
        ...
        final Class<?> c = ClassLoaderUtils.class.getClassLoader().loadClass(
                className);
        return invokeMethodFromClass(c, methodName, args);
    }
     ...
     */
    public static Object invokeMainMethodFromClass(final Class<?> c,
     ...
     */
    public static Object invokeMethodFromClass(final Class<?> c,
            final String methodName) throws ClassNotFoundException,
            NoSuchMethodException, InvocationTargetException {
        log.debug("invokeMethodFromClass({}, {})",
                new Object[] { c, methodName });
    ...
    public static Object invokeMethodFromClass(final Class<?> c,
            ...
            InvocationTargetException, IllegalArgumentException,
            SecurityException, InstantiationException {
        log.debug("invokeMethodFromClass({}, {}, {})", new Object[] { c,
                methodName, args });
        final Method m = c.getMethod(methodName, args.getClass());
        m.setAccessible(true);
        final int mods = m.getModifiers();
     ...
     * Invoke methodName with arguments from class.
     */
    public static Object invokeAutomationMethod(final String className,
            final String methodName, final Map<String, Object> env,
            final Object[] params) throws ClassNotFoundException,
            SecurityException, NoSuchMethodException, IllegalArgumentException,
            InvocationTargetException, InstantiationException {
        log.debug("invokeAutomationMethod({}, {}, {})", new Object[] {
                className, methodName, env, params });
        final Class<?> c = ClassLoaderUtils.class.getClassLoader().loadClass(
                className);
        final Method m = c.getMethod(methodName, env.getClass(),
                params.getClass());
