...
public class MetadataExtractor {
    ...
    public static void OpenOfficeExtractor(InputStream is) {
        ...
        if (odmt != null) {
            ...
            md.setEditingDuration((long) odmt.getEditingDuration().getSeconds() + odmt.getEditingDuration().getMinutes() * 60
                    + odmt.getEditingDuration().getHours() * 3600 + odmt.getEditingDuration().getDays() * 86400);
