...
public class CmisServiceFactory extends AbstractServiceFactory {
    ...
    public CmisService getService(CallContext context) {
        ...
        CmisServiceWrapper<CmisService> wrapperService =
                new CmisServiceWrapper<CmisService>(service, DEFAULT_MAX_ITEMS_TYPES, DEFAULT_DEPTH_TYPES, DEFAULT_MAX_ITEMS_OBJECTS,
