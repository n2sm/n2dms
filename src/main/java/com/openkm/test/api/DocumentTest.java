...
public class DocumentTest extends TestCase {
    ...
    public void testVersions() throws IOException, UnsupportedMimeTypeException, FileSizeExceededException, UserQuotaExceededException,
        ...
        Version ver =
                okmDocument.checkin(token, BASE + "/omega.txt", new ByteArrayInputStream("sample text 1.1".getBytes()), "New version 1.1");
        ...
        Thread.sleep(1000); // Version date need to be different
        ver =
                okmDocument.checkin(token, BASE + "/omega.txt", new ByteArrayInputStream("sample text 2.0".getBytes()), "New version 2.0",
