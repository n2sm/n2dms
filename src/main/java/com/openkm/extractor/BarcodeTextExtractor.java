...
public class BarcodeTextExtractor extends AbstractTextExtractor {
    ...
    private static final Logger log = LoggerFactory
            .getLogger(BarcodeTextExtractor.class);

    /**
     * Creates a new <code>TextExtractor</code> instance.
     */
    public BarcodeTextExtractor() {
        super(new String[] { "image/tiff", "image/gif", "image/jpeg",
                "image/png" });
    }
     ...
     */
    public BarcodeTextExtractor(final String[] contentTypes) {
        super(contentTypes);
    }
    ...
    public Reader extractText(final InputStream stream, final String type,
        ...
        try {
            final com.google.zxing.Reader reader = new MultiFormatReader();
