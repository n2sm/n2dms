...
public class ProfileServlet extends BaseServlet {
    ...
    private void create(String userId, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException,
            DatabaseException, AccessDeniedException, RepositoryException, ParseException, WorkflowException {
     ...
     * Clone profile
     */
    private void clone(String userId, HttpServletRequest request, HttpServletResponse response) throws DatabaseException, IOException,
            ParseException, AccessDeniedException, RepositoryException, WorkflowException, ServletException {
    ...
    private Profile getUserProfile(HttpServletRequest request) {
        ...
        prf.getPrfMenu().getPrfFile()
                .setSendDocumentAttachmentVisible(WebUtils.getBoolean(request, "prf_menu_file_send_document_attachment_visible"));
        ...
        prf.getPrfMenu().getPrfEdit()
                .setUpdatePropertyGroupVisible(WebUtils.getBoolean(request, "prf_menu_edit_update_property_group_visible"));
        prf.getPrfMenu().getPrfEdit()
