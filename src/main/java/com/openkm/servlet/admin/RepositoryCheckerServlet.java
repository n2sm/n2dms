        ...
        try {
            if (!repoPath.equals("")) {
                ...
                if (Config.REPOSITORY_NATIVE) {
                    stats =
                            DbRepositoryChecker.checkDocuments(null, repoPath, fast, versions, checksum, out, new HTMLInfoDecorator(
                                    (int) cInfo.getDocuments()));
                } else {
                    stats =
                            JcrRepositoryChecker.checkDocuments(null, repoPath, versions, out,
