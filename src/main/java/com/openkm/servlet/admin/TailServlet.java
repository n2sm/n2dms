...
public class TailServlet extends BaseServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        out.println("<td><a class=\"ds\" href=\"../extension/DataBrowser?action=fs&sel=doc&dst=fsPath&root=" + Config.INSTANCE_CHROOT_PATH
                + "\"><img src=\"img/action/browse_fs.png\"/></a></td>");
        out.println("</tr>");
        out.println("<tr>");
