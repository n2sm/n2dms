...
public class BenchmarkServlet extends BaseServlet {
    ...
    private void okmImport(HttpServletRequest request, HttpServletResponse response, String base) throws IOException {
        ...
        try {
            ...
            for (int i = 0; i < times; i++) {
                ...
                OKMFolder.getInstance().create(null, fld);
                ImpExpStats stats =
                        RepositoryImporter.importDocuments(null, dir, fld.getPath(), false, false, false, out, new HTMLInfoDecorator(docs));
        ...
        UserActivity.log(
                ...
                null,
                null,
                "Size: " + FormatUtil.formatSize(tStats.getSize()) + ", Folders: " + tStats.getFolders() + ", Documents: "
                        + tStats.getDocuments() + ", Time: " + FormatUtil.formatSeconds(tEnd - tBegin));
    ...
    private void okmCopy(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        UserActivity.log(request.getRemoteUser(), "ADMIN_BENCHMARK_OKM_COPY", null, null,
                "Size: " + FormatUtil.formatSize(cInfo.getSize() * times) + ", Folders: " + cInfo.getMails() * times + ", Documents: "
                        + cInfo.getDocuments() * times + ", Time: " + FormatUtil.formatSeconds(tEnd - tBegin));
     ...
     */
    private void okmApiHighGenerate(HttpServletRequest request, HttpServletResponse response, String base) throws IOException {
        ...
        UserActivity.log(
                request.getRemoteUser(),
                "ADMIN_BENCHMARK_OKM_API_HIGH",
                null,
                null,
                "Size: " + FormatUtil.formatSize(bm == null ? 0 : bm.getTotalSize()) + ", Folders: "
                        + (bm == null ? 0 : bm.getTotalFolders()) + ", Documents: " + (bm == null ? 0 : bm.getTotalDocuments())
     ...
     */
    private void okmApiLowGenerate(HttpServletRequest request, HttpServletResponse response, String base) throws IOException {
        ...
        UserActivity.log(
                request.getRemoteUser(),
                "ADMIN_BENCHMARK_OKM_API_LOW",
                null,
                null,
                "Size: " + FormatUtil.formatSize(bm.getTotalSize()) + ", Folders: " + bm.getTotalFolders() + ", Documents: "
                        + bm.getTotalDocuments() + ", Time: " + FormatUtil.formatSeconds(elapse));
     ...
     * Generate documents into repository (OpenKM RAW)
     */
    private void okmRawGenerate(HttpServletRequest request, HttpServletResponse response, String base) throws IOException {
