...
public class JcrRepositoryViewServlet extends BaseServlet {
    ...
    private static final String[] NODE_TYPE = { "UNDEFINED", "STRING", "BINARY", "LONG", "DOUBLE", "DATE", "BOOLEAN", "NAME", "PATH",
            "REFERENCE" };
     ...
     * Unlock node
     */
    private void unlock(Session session, String path, HttpServletRequest request, HttpServletResponse response) throws ServletException,
            IOException, javax.jcr.PathNotFoundException, RepositoryException, DatabaseException {
     ...
     * Node check-in
     */
    private void checkin(Session session, String path, HttpServletRequest request, HttpServletResponse response) throws ServletException,
            IOException, javax.jcr.PathNotFoundException, RepositoryException {
     ...
     * Edit property
     */
    private void edit(Session session, String path, HttpServletRequest request, HttpServletResponse response) throws ServletException,
            IOException, javax.jcr.PathNotFoundException, RepositoryException {
     ...
     * Save property
     */
    private void save(Session session, String path, HttpServletRequest request, HttpServletResponse response) throws ServletException,
            IOException, javax.jcr.PathNotFoundException, RepositoryException {
     ...
     */
    private void list(Session session, String path, HttpServletRequest request, HttpServletResponse response) throws ServletException,
            IOException, javax.jcr.PathNotFoundException, RepositoryException {
    ...
    private String createBreadcrumb(String path) throws UnsupportedEncodingException {
        ...
        if (idx > 0) {
            ...
            return createBreadcrumb(parent) + " / <a href=\"JcrRepositoryView?path=" + URLEncoder.encode(path, "UTF-8") + "\">" + name
                    + "</a>";
        } else {
            if (!path.substring(1).equals("")) {
                return "<a href=\"JcrRepositoryView?path=\">ROOT</a> / <a href=\"JcrRepositoryView?path="
                        + URLEncoder.encode(path, "UTF-8") + "\">" + path.substring(1) + "</a>";
            } else {
     ...
     */
    private String toString(Value[] v, String delim) throws ValueFormatException, IllegalStateException, RepositoryException {
