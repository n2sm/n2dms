...
public class FolderService {
    ...
    @WebMethod
    public Folder create(@WebParam(name = "token") String token, @WebParam(name = "fld") Folder fld) throws AccessDeniedException,
            RepositoryException, PathNotFoundException, ItemExistsException, DatabaseException, ExtensionException, AutomationException {
    ...
    @WebMethod
    public void delete(@WebParam(name = "token") String token, @WebParam(name = "fldPath") String fldPath) throws LockException,
