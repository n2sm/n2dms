...
public class Dropbox {
     ...
     * access
     */
    public Account access(String usrId) throws DropboxUnlinkedException, DropboxServerException, DropboxIOException, DropboxException,
            DatabaseException {
        if (!session.isLinked()) {
            return null;
        }
     ...
     * uploadFile
     */
    public void uploadFile(String path, InputStream inputStream, long length) throws DropboxUnlinkedException, DropboxServerException,
     ...
     * downloadFile
     */
    public DropboxFileInfo downloadFile(String path, OutputStream outputStream) throws DropboxUnlinkedException, DropboxServerException,
            DropboxPartialFileException, DropboxIOException, DropboxException {
     ...
     * search
     */
    public List<Entry> search(String query) throws DropboxUnlinkedException, DropboxServerException, DropboxIOException, DropboxException {
     ...
     * getClildren
     */
    public List<Entry> getClildren(String parentPath) throws DropboxUnlinkedException, DropboxServerException, DropboxIOException,
            DropboxException {
     ...
     * isChildren
     */
    public boolean ischildren(Entry e) throws DropboxUnlinkedException, DropboxServerException, DropboxIOException, DropboxException {
     ...
     * createFolder
     */
    public Entry createFolder(String path) throws DropboxUnlinkedException, DropboxServerException, DropboxIOException, DropboxException {
