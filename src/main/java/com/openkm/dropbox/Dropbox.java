...
public class Dropbox {
     ...
     * Dropbox
     */
    public Dropbox() throws DropboxUnlinkedException, DropboxServerException,
     ...
     * access
     */
    public Account access(final String usrId) throws DropboxUnlinkedException,
        ...
        if (accessTokenKey != null && accessTokenSecret != null) {
            final AccessTokenPair reAuthTokens = new AccessTokenPair(
            ...
            final RequestTokenPair tokens = new RequestTokenPair(tokenPair.key,
                    tokenPair.secret);
     ...
     * uploadFile
     */
    public void uploadFile(final String path, final InputStream inputStream,
            final long length) throws DropboxUnlinkedException,
            DropboxServerException, DropboxIOException, DropboxException {
     ...
     * downloadFile
     */
    public DropboxFileInfo downloadFile(final String path,
            final OutputStream outputStream) throws DropboxUnlinkedException,
            DropboxServerException, DropboxPartialFileException,
            DropboxIOException, DropboxException {
     ...
     * search
     */
    public List<Entry> search(final String query)
     ...
     * getClildren
     */
    public List<Entry> getClildren(final String parentPath)
            throws DropboxUnlinkedException, DropboxServerException,
            DropboxIOException, DropboxException {
     ...
     * getRoot
     */
    public Entry getRoot() throws DropboxUnlinkedException,
            DropboxServerException, DropboxIOException, DropboxException {
     ...
     * isChildren
     */
    public boolean ischildren(final Entry e) throws DropboxUnlinkedException,
            DropboxServerException, DropboxIOException, DropboxException {
        boolean children = false;

        if (e.isDir) {
            final Entry entreis = dropboxAPI.metadata(e.path, 0, null, true,
                    null);
            for (final Entry entry : entreis.contents) {
                if (entry.isDir) {
                    children = true;
                    break;
                }
     ...
     * createFolder
     */
    public Entry createFolder(final String path)
            throws DropboxUnlinkedException, DropboxServerException,
            DropboxIOException, DropboxException {
