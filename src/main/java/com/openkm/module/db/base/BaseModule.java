...
public class BaseModule {
     ...
     * Get properties
     */
    public static Version getProperties(final NodeDocumentVersion nDocVersion)
     ...
     * Get properties
     */
    public static LockInfo getProperties(final NodeLock nLock,
            final String nPath) throws DatabaseException {
        log.debug("getProperties({})", nLock);
        final LockInfo lck = new LockInfo();
