...
public interface PropertyGroupModule {
     ...
     */
    public void addGroup(String token, String nodePath, String grpName)
     ...
     * @throws RepositoryException If there is any general repository problem.
     */
    public void removeGroup(String token, String nodePath, String grpName)
     ...
     * @throws RepositoryException If there is any general repository problem.
     */
    public List<PropertyGroup> getGroups(String token, String nodePath)
     ...
     * @throws RepositoryException If there is any general repository problem.
     */
    public List<PropertyGroup> getAllGroups(String token) throws IOException,
     ...
     * @throws RepositoryException If there is any general repository problem.
     */
    public List<FormElement> getProperties(String token, String nodePath,
            String grpName) throws IOException, ParseException,
     ...
     * @throws RepositoryException If there is any general repository problem.
     */
    public void setProperties(String token, String nodePath, String grpName,
            List<FormElement> properties) throws IOException, ParseException,
            NoSuchPropertyException, NoSuchGroupException, LockException,
    ...
    public List<FormElement> getPropertyGroupForm(String token, String grpName)
            throws ParseException, IOException, RepositoryException,
            DatabaseException;
     ...
     * @throws RepositoryException If there is any general repository problem.
     */
    public boolean hasGroup(String token, String nodePath, String grpName)
            throws IOException, ParseException, PathNotFoundException,
            RepositoryException, DatabaseException;
}
