...
public interface DocumentModule {
     ...
     * @throws RepositoryException If there is any general repository problem.
     */
    public void checkout(String token, String docPath) throws LockException,
            PathNotFoundException, AccessDeniedException, RepositoryException,
            DatabaseException;
     ...
     * @throws RepositoryException If there is any general repository problem.
     */
    public void forceCancelCheckout(String token, String docPath)
            throws LockException, PathNotFoundException, AccessDeniedException,
     ...
     * @throws RepositoryException If there is any general repository problem.
     */
    public Version checkin(String token, String docPath, InputStream is,
            String comment) throws FileSizeExceededException,
            UserQuotaExceededException, VirusDetectedException, LockException,
     ...
     * @throws RepositoryException If there is any general repository problem.
     */
    public LockInfo lock(String token, String docPath) throws LockException,
            PathNotFoundException, AccessDeniedException, RepositoryException,
            DatabaseException;
     ...
     * @throws RepositoryException If there is any general repository problem.
     */
    public void forceUnlock(String token, String docPath) throws LockException,
            PathNotFoundException, AccessDeniedException, RepositoryException,
     ...
     * @throws PathNotFoundException If there is no document in the repository with this path.
     */
    public void purge(String token, String docPath) throws LockException,
     ...
     * @throws RepositoryException If there is any general repository problem.
     */
    public boolean isValid(String token, String docId)
            throws PathNotFoundException, RepositoryException,
            DatabaseException;
