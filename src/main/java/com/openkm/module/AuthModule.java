...
public interface AuthModule {
     ...
     */
    public void logout(String token) throws RepositoryException,
            DatabaseException;
    ...
    public void grantUser(String token, String nodePath, String user,
            int permissions, boolean recursive) throws PathNotFoundException,
     ...
     * @throws RepositoryException If there is any error accessing to the repository.
     */
    public Map<String, Integer> getGrantedUsers(String token, String nodePath)
     ...
     * @throws RepositoryException If there is any error accessing to the repository.
     */
    public void revokeRole(String token, String nodePath, String role,
            int permissions, boolean recursive) throws PathNotFoundException,
            AccessDeniedException, RepositoryException, DatabaseException;
     ...
     * @throws RepositoryException If there is any error accessing to the repository.
     */
    public Map<String, Integer> getGrantedRoles(String token, String nodePath)
            throws PathNotFoundException, AccessDeniedException,
            RepositoryException, DatabaseException;
     ...
     */
    public List<String> getUsersByRole(String token, String role)
     ...
     * @throws RepositoryException If there is any error retrieving the roles list.
     */
    public List<String> getRolesByUser(String token, String user)
            throws PrincipalAdapterException;
     ...
     */
    public String getMail(String token, String user)
            throws PrincipalAdapterException;
     ...
     * @throws RepositoryException If there is any error retrieving the mail.
     */
    public String getName(String token, String user)
            throws PrincipalAdapterException;

    /**
     * Change several security permissions in the same call.
     */
    public void changeSecurity(String token, String nodePath,
            Map<String, Integer> grantUsers, Map<String, Integer> revokeUsers,
            Map<String, Integer> grantRoles, Map<String, Integer> revokeRoles,
            boolean recursive) throws PathNotFoundException,
            AccessDeniedException, RepositoryException, DatabaseException;
}
