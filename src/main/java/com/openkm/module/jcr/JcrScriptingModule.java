...
public class JcrScriptingModule implements ScriptingModule {
    private static Logger log = LoggerFactory
            .getLogger(JcrScriptingModule.class);

    @Override
    public void setScript(final String token, final String nodePath,
            final String code) throws PathNotFoundException,
            AccessDeniedException, RepositoryException, DatabaseException {
        log.debug("setScript({}, {}, {})",
                new Object[] { token, nodePath, code });
        Node node = null;
        Node sNode = null;
        ...
        try {
            ...
            if (PrincipalUtils.hasRole(Config.DEFAULT_ADMIN_ROLE)) {
                final Session systemSession = JcrRepositoryModule
                        .getSystemSession();
                ...
                // Activity log
                UserActivity.log(session.getUserID(), "SET_SCRIPT",
                        node.getUUID(), nodePath, code);
            } else {
    ...
    @Override
    public void removeScript(final String token, final String nodePath)
        ...
        try {
            ...
            if (PrincipalUtils.hasRole(Config.DEFAULT_ADMIN_ROLE)) {
                ...
                // Activity log
                UserActivity.log(session.getUserID(), "REMOVE_SCRIPT",
    ...
    @Override
    public String getScript(final String token, final String nodePath)
            throws PathNotFoundException, AccessDeniedException,
            RepositoryException, DatabaseException {
