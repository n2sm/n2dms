...
public class BaseFolderModule {
     ...
     * Create a new folder
     */
    public static Node create(Session session, Node parentNode, String name) throws javax.jcr.ItemExistsException,
            javax.jcr.PathNotFoundException, NoSuchNodeTypeException, javax.jcr.lock.LockException, VersionException,
     ...
     */
    public static Folder getProperties(Session session, Node fldNode) throws javax.jcr.PathNotFoundException, javax.jcr.RepositoryException {
     ...
     */
    public static void copy(Session session, Node srcFolderNode, Node dstFolderNode) throws NoSuchNodeTypeException, VersionException,
            ConstraintViolationException, javax.jcr.lock.LockException, javax.jcr.RepositoryException, IOException, DatabaseException,
     ...
     */
    public static ContentInfo getContentInfo(Node folderNode) throws AccessDeniedException, RepositoryException, PathNotFoundException {
    ...
    public static boolean hasLockedNodes(Node node) throws javax.jcr.RepositoryException {
        ...
        for (NodeIterator ni = node.getNodes(); ni.hasNext();) {
            ...
            if (child.isNodeType(Document.TYPE)) {
                ...
                throw new javax.jcr.RepositoryException("Unknown node type: " + child.getPrimaryNodeType().getName() + "("
                        + child.getPath() + ")");
            }
        }
     ...
     */
    public static void purge(Session session, Node fldNode) throws VersionException, javax.jcr.lock.LockException,
            ConstraintViolationException, javax.jcr.RepositoryException {
     ...
     */
    public static void getContentInfoVisitor(Session session, Node node) throws NoSuchNodeTypeException, VersionException,
