...
public class NodeDocumentDAO {
     ...
     */
    public synchronized NodeDocumentVersion create(NodeDocument nDoc, InputStream is, long size) throws PathNotFoundException,
    ...
    public List<NodeDocument> findByCategory(String catUuid) throws PathNotFoundException, DatabaseException {
        ...
        final String sql =
                "select NBS_UUID from OKM_NODE_CATEGORY, OKM_NODE_DOCUMENT " + "where NCT_CATEGORY = :catUuid and NCT_NODE = NBS_UUID";
    ...
    public List<NodeDocument> findByKeyword(String keyword) throws DatabaseException {
        ...
        final String sql =
                "select NBS_UUID from OKM_NODE_KEYWORD, OKM_NODE_DOCUMENT " + "where NKW_KEYWORD = :keyword and NKW_NODE = NBS_UUID";
        List<NodeDocument> ret = new ArrayList<NodeDocument>();
        Session session = null;
        Transaction tx = null;
    ...
    public List<NodeDocument> findByPropertyValue(String group, String property, String value) throws DatabaseException {
        ...
        String qs =
                "select nb from NodeDocument nb join nb.properties nbp where nbp.group=:group and nbp.name=:property and nbp.value like :value";
        Session session = null;
        Transaction tx = null;
    ...
    public long getSize(String context) throws PathNotFoundException, DatabaseException {
        ...
        String qs =
                "select coalesce(sum(ndv.size), 0) from NodeDocumentVersion ndv " + "where ndv.current = :current and ndv.parent in "
