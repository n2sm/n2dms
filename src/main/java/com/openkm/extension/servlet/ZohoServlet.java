...
public class ZohoServlet extends OKMRemoteServiceServlet implements OKMZohoService {
    ...
    public Map<String, String> getZohoWriterUrl(String uuid, String lang) throws OKMException {
        ...
        try {
            ...
            throw new OKMException(ErrorCode.get(ErrorCode.ORIGIN_OKMZohoService, ErrorCode.CAUSE_AccessDenied), e.getMessage());
    ...
    private Map<String, String> sendToZoho(String zohoUrl, String nodeUuid, String lang) throws PathNotFoundException,
        ...
        try {
            ...
            Part[] parts =
                    { new FilePart("content", tmp), new StringPart("apikey", Config.ZOHO_API_KEY), new StringPart("output", "url"),
                            new StringPart("mode", "normaledit"), new StringPart("filename", fileName),
                            new StringPart("skey", Config.ZOHO_SECRET_KEY), new StringPart("lang", lang), new StringPart("id", id),
