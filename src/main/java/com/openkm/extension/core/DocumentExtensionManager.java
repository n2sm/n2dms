...
public class DocumentExtensionManager {
    ...
    public void postCheckin(Session session, Ref<Node> refDocumentNode, Ref<Version> refVersion) throws AccessDeniedException,
            RepositoryException, PathNotFoundException, LockException, VersionException, DatabaseException, ExtensionException {
