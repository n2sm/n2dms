...
public class InvitationPopup extends DialogBox {
    ...
    public InvitationPopup() {
        ...
        commentTXT = new HTML("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + GeneralComunicator.i18nExtension("openmeetings.invitate.comment"));
        subjectTXT = new HTML("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + GeneralComunicator.i18nExtension("openmeetings.invitate.subject"));
        ...
        sendButton = new Button(GeneralComunicator.i18nExtension("button.send"), new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                if (!users.equals("") || !roles.equals("")) {
                    errorNotify.setVisible(false);
                    OpenMeetings.get().toolBarBoxOpenMeeting.manager.sendInvitation(roomId, users, roles, subject.getText(),
                            message.getText());
                    hide();
                    reset();
                } else {
