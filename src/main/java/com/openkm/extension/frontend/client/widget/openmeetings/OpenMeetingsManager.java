...
public class OpenMeetingsManager extends Composite {
    private final OKMOpenMeetingsServiceAsync openMeetingsService = (OKMOpenMeetingsServiceAsync) GWT.create(OKMOpenMeetingsService.class);
    ...
    public void enterPublicRoom(final String roomName, final long roomId) {
        openMeetingsService.loginUser(new AsyncCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                openMeetingsService.getPublicRoomURL(SID, roomId, moderator, showAudioVideoTest, lang, new AsyncCallback<String>() {
                    @Override
                    public void onSuccess(String result) {
     ...
     * createNewRoom
     */
    public void createNewRoom(final String name, final long roomType, final long numberOfPartizipants, final boolean isPublic,
            final boolean appointment, final boolean moderated, final boolean allowUserQuestions, final boolean audioOnly,
        ...
        openMeetingsService.loginUser(new AsyncCallback<String>() {
            ...
            public void onSuccess(String result) {
                String SID = result;
                openMeetingsService.createNewRoom(SID, name, roomType, numberOfPartizipants, isPublic, appointment, moderated,
                        allowUserQuestions, audioOnly, waitForRecording, allowRecording, topBar, new AsyncCallback<Object>() {
                            @Override
     ...
     * sendInvitation
     */
    public void sendInvitation(final long roomId, final String users, final String roles, final String subject, final String message) {
        OpenMeetings.get().generalStatus.setSendInvitation();
        openMeetingsService.loginUser(new AsyncCallback<String>() {
            @Override
            public void onSuccess(String result) {
                String SID = result;
                openMeetingsService.sendInvitation(SID, roomId, users, roles, subject, message, GeneralComunicator.getLang(),
