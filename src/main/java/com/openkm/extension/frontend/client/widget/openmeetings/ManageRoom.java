...
public class ManageRoom extends Composite {
    ...
    public ManageRoom() {
        ...
        allowUserQuestions = new HTML("<b>" + GeneralComunicator.i18nExtension("openmeetings.room.allowuserquestions") + "</b>");
        ...
        // wait for recording
        waitForRecording = new HTML("<b>" + GeneralComunicator.i18nExtension("openmeetings.room.waitforrecording") + "</b>");
        ...
        create.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                OpenMeetings.get().toolBarBoxOpenMeeting.manager.createNewRoom(roomName, roomType, numberOfPartizipants, isPublic,
                        isAppointment, isModerated, isAllowUserQuestions, isAudioOnly, isWaitForRecording, isAllowRecording, isTopBar);
                reset();
            }
        });
    ...
    private void firstTimeInitTypeList() {
        if (GeneralComunicator.getWorkspace() != null) {
            ...
            typeList.addItem(GeneralComunicator.i18nExtension("openmeetings.room.type.restricted"), String.valueOf(GWTRoom.TYPE_RESTRICTED));
            typeList.addItem(GeneralComunicator.i18nExtension("openmeetings.room.type.interview"), String.valueOf(GWTRoom.TYPE_INTERVIEW));
    ...
    public void langRefresh() {
        ...
        typeList.clear();
        if (GeneralComunicator.getWorkspace().isAdminRole()) {
            typeList.addItem(GeneralComunicator.i18nExtension("openmeetings.room.type.conference"), String.valueOf(GWTRoom.TYPE_CONFERENCE));
        }
        typeList.addItem(GeneralComunicator.i18nExtension("openmeetings.room.type.restricted"), String.valueOf(GWTRoom.TYPE_RESTRICTED));
        typeList.addItem(GeneralComunicator.i18nExtension("openmeetings.room.type.interview"), String.valueOf(GWTRoom.TYPE_INTERVIEW));
        ...
        allowUserQuestions.setHTML("<b>" + GeneralComunicator.i18nExtension("openmeetings.room.allowuserquestions") + "</b>");
        audioOnly.setHTML("<b>" + GeneralComunicator.i18nExtension("openmeetings.room.only.audio") + "</b>");
        waitForRecording.setHTML("<b>" + GeneralComunicator.i18nExtension("openmeetings.room.waitforrecording") + "</b>");
