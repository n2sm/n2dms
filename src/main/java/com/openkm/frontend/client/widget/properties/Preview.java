...
public class Preview extends Composite {
    ...
    public Preview() {
        ...
        hPanel.add(space);
        hPanel.add(video);
        hPanel.setCellHorizontalAlignment(text,
                HasHorizontalAlignment.ALIGN_CENTER);
        hPanel.setCellVerticalAlignment(text, HasVerticalAlignment.ALIGN_MIDDLE);
        hPanel.setCellHorizontalAlignment(video,
                HasHorizontalAlignment.ALIGN_CENTER);
        hPanel.setCellVerticalAlignment(video,
     ...
     */
    public void showEmbedSWF(final String Uuid) {
        hideWidgetExtension();
        ...
        if (previewAvailable) {
            ...
            text.setHTML("<div id=\"pdfviewercontainer\" align=\"center\"><br><br>"
                    + Main.i18n("preview.unavailable") + "</div>\n"); // needed for rewriting purpose
        }
    }
     ...
     * resizeEmbedSWF
     */
    public void resizeEmbedSWF(final int width, final int height) {
        if (Main.get().workspaceUserProperties.getWorkspace().getPreviewer()
                .equals("flexpaper")) {
     ...
     */
    public void showMediaFile(final String mediaUrl, final String mimeType) {
        hideWidgetExtension();
     ...
     * resizeMediaFile
     */
    public void resizeMediaFile(final int width, final int height) {
