...
public class Mail extends Composite {
    ...
    public Mail() {
        ...
        keywordManager = new KeywordManager(
                ThesaurusSelectPopup.MAIL_PROPERTIES);
        table = new FlexTable();
    ...
    public void set(final GWTMail mail) {
        ...
        url += "?uuid="
                + URL.encodeQueryString(URL.encodeQueryString(mail.getUuid()));
        tableProperties.setWidget(8, 1, new HTML(
        ...
        tableProperties.setHTML(4, 1, dtf.format(mail.getCreated()) + " "
