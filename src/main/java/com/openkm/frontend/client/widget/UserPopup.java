    ...
    public UserPopup() {
            ...
            public void onClick(ClickEvent event) {
                ...
                if (!userPasswordText.getText().equals(userPasswordTextVerify.getText())) {
                    ...
                    // Case creation
                        ...
                        && (mailFolderText.getText().length() > 0 || mailUserText.getText().length() > 0 || mailHostText.getText().length() > 0)) {
                    ...
                    // Case update
                        ...
                        && !(mailFolderText.getText().length() > 0 && mailUserText.getText().length() > 0 && mailHostText.getText()
                                .length() > 0)) {
        ...
        testButton = new Button(Main.i18n("button.test"), new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                String proto = mailProtocolList.getValue(mailProtocolList.getSelectedIndex());
                generalService.testMailConnection(proto, mailHostText.getText(), mailUserText.getText(), mailUserPasswordText.getText(),
                        mailFolderText.getText(), new AsyncCallback<GWTTestMail>() {
                            @Override
                            public void onSuccess(GWTTestMail result) {
                                if (!result.isError()) {
                                    ...
                                    mailTestError.setHTML(Main.i18n("user.preferences.mail.test.error") + "<br>" + result.getErrorMsg());
        ...
        mailFlexTable.getFlexCellFormatter().setAlignment(6, 0, HasHorizontalAlignment.ALIGN_CENTER, HasVerticalAlignment.ALIGN_MIDDLE);
