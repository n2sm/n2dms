...
public class WorkflowWidget extends Composite {
     ...
     * WorkflowWidget
     */
    public WorkflowWidget(final String name, final String uuid,
            final WorkflowWidgetToFire workflowWidgetToFire,
            final Map<String, Object> workflowVariables) {
        this.name = name;
        this.uuid = uuid;
    ...
    private void runProcessDefinitionWithValues() {
        workflowService.runProcessDefinition(uuid, name,
    ...
    final AsyncCallback<Map<String, List<GWTFormElement>>> callbackGetProcessDefinitionForms = new AsyncCallback<Map<String, List<GWTFormElement>>>() {
        ...
        public void onSuccess(final Map<String, List<GWTFormElement>> result) {
            ...
            manager.setFormElements(result.get(Main.get().workspaceUserProperties
                    .getWorkspace().getWorkflowRunConfigForm()));
     ...
     */
    public void getProcessDefinitionForms(final String name) {
        workflowService.getProcessDefinitionFormsByName(name,
