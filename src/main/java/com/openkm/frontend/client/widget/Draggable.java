...
public class Draggable extends Composite implements OriginPanel {
                        ...
                        if (clickedTreeItem != null
                            ...
                            if (draggedTreeItem != clickedTreeItem && !isChild) {
                                ...
                                ObjectToMove objToMove =
                                        new ObjectToMove(gwtFolder, dstPath, null, draggedTreeItem, parentItem, clickedTreeItem);
                            ...
                            if (!dstPath.equals(((GWTFolder) actualTreeItem.getUserObject()).getPath())) {
                                ...
                                if (Main.get().mainPanel.desktop.browser.fileBrowser.isFolderSelected()) {
                                    ...
                                    if (!dstPath.startsWith(fldPath)) {
                                        ...
                                        ObjectToMove objToMove =
                                                new ObjectToMove(gwtFolder, dstPath, fldPath, movedTreeItem, actualTreeItem,
                                                        clickedTreeItem);
                                        Main.get().confirmPopup.setConfirm(ConfirmPopup.CONFIRM_DRAG_DROP_MOVE_FOLDER_FROM_BROWSER);
                                        Main.get().confirmPopup.setValue(objToMove);
                                        Main.get().confirmPopup.show();
                                    }
                                    ...
                                    ObjectToMove objToMove = new ObjectToMove(gwtDocument, dstPath, null, null, null, null);
                                    Main.get().confirmPopup.setConfirm(ConfirmPopup.CONFIRM_DRAG_DROP_MOVE_DOCUMENT);
                                    Main.get().confirmPopup.setValue(objToMove);
                                    Main.get().confirmPopup.show();
                                    ...
                                    GWTMail gwtMail = Main.get().mainPanel.desktop.browser.fileBrowser.getMail(); // The
                                                                                                                  // dragged
                                                                                                                  // document
                                    ObjectToMove objToMove = new ObjectToMove(gwtMail, dstPath, null, null, null, null);
    ...
    public class ObjectToMove {
         ...
         * ObjectToMove
         */
        public ObjectToMove(Object object, String dstPath, String fldPath, TreeItem treeItem, TreeItem treeItem2, TreeItem treeItem3) {
            this.object = object;
