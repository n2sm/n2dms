...
public class FileBrowserController extends Composite {
        ...
        folder.addClickHandler(new ClickHandler() {
            ...
            public void onClick(final ClickEvent event) {
                if (controller.isFolder()) {
                    folder.setResource(OKMBundleResources.INSTANCE
                            .folderDisabled());
        ...
        document.addClickHandler(new ClickHandler() {
            ...
            public void onClick(final ClickEvent event) {
                if (controller.isDocument()) {
                    document.setResource(OKMBundleResources.INSTANCE
                            .documentDisabled());
    ...
    public void setProfileExplorer(final GWTProfileExplorer profileExplorer) {
        if (profileExplorer.isTypeFilterEnabled()) {
            ...
            hPanel.add(mail);
            hPanel.add(Util.hSpace("5"));
            hPanel.setCellVerticalAlignment(folder,
                    HasVerticalAlignment.ALIGN_MIDDLE);
            hPanel.setCellVerticalAlignment(document,
                    HasVerticalAlignment.ALIGN_MIDDLE);
            hPanel.setCellVerticalAlignment(mail,
                    HasVerticalAlignment.ALIGN_MIDDLE);
        }
