    ...
    public MainMenu() {
        ...
        findSimilarDocument =
                new MenuItem(Util.menuHTML("img/icon/actions/similar_find.png", Main.i18n("general.menu.file.find.similar.document")),
                        true, findSimilarDocumentOKM);
        findSimilarDocument.addStyleName("okm-MainMenuItem");
        createFolder =
                new MenuItem(Util.menuHTML("img/icon/actions/add_folder.gif", Main.i18n("general.menu.file.create.directory")), true,
                        createFolderOKM);
        createFolder.addStyleName("okm-MainMenuItem");
        addDocument =
                new MenuItem(Util.menuHTML("img/icon/actions/add_document.gif", Main.i18n("general.menu.file.add.document")), true,
                        addDocumentOKM);
        addDocument.addStyleName("okm-MainMenuItem");
        download =
                new MenuItem(Util.menuHTML("img/icon/actions/download.gif", Main.i18n("general.menu.file.download.document")), true,
                        downloadOKM);
        download.addStyleName("okm-MainMenuItem");
        downloadPdf =
                new MenuItem(Util.menuHTML("img/icon/actions/download_pdf.gif", Main.i18n("general.menu.file.download.document.pdf")),
                        true, downloadPdfOKM);
        downloadPdf.addStyleName("okm-MainMenuItem");
        sendDocumentLink =
                new MenuItem(Util.menuHTML("img/icon/actions/send_document_link.gif", Main.i18n("general.menu.file.send.link")), true,
                        sendDocumentLinkOKM);
        sendDocumentLink.addStyleName("okm-MainMenuItem");
        sendDocumentAttachment =
                new MenuItem(
                        Util.menuHTML("img/icon/actions/send_document_attachment.gif", Main.i18n("general.menu.file.send.attachment")),
                        true, sendDocumentAttachmentOKM);
        sendDocumentAttachment.addStyleName("okm-MainMenuItem");
        forwardMail =
                new MenuItem(Util.menuHTML("img/email_forward.png", Main.i18n("general.menu.file.send.forward.mail")), true,
                        sendMailForwardOKM);
        forwardMail.addStyleName("okm-MainMenuItem");
        createFromTemplate =
                new MenuItem(
                        Util.menuHTML("img/icon/actions/create_from_template.gif", Main.i18n("general.menu.file.create.from.template")),
                        true, createFromTemplateOKM);
        ...
        startWorkflow =
                new MenuItem(Util.menuHTML("img/icon/actions/start_workflow.gif", Main.i18n("general.menu.file.start.workflow")), true,
                        startWorkflowOKM);
        ...
        cancelCheckout =
                new MenuItem(Util.menuHTML("img/icon/actions/cancel_checkout.gif", Main.i18n("general.menu.edit.cancel.checkout")), true,
                        cancelCheckoutOKM);
        ...
        removePropertyGroup =
                new MenuItem(Util.menuHTML("img/icon/actions/remove_property_group.gif",
        ...
        addSubscription =
                new MenuItem(Util.menuHTML("img/icon/actions/add_subscription.gif", Main.i18n("general.menu.edit.add.subscription")), true,
                        addSubscriptionOKM);
        addSubscription.addStyleName("okm-MenuItem-strike");
        removeSubscription =
                new MenuItem(Util.menuHTML("img/icon/actions/remove_subscription.gif", Main.i18n("general.menu.edit.remove.subscription")),
                        true, removeSubscriptionOKM);
        ...
        // Submenu language
        language =
                new MenuItem(Util.menuHTML("img/icon/menu/language.gif", Main.i18n("general.menu.tools.languages")), true, subMenuLanguage);
        ...
        skinDefault =
                new MenuItem(Util.menuHTML("img/icon/menu/skin_default.gif", Main.i18n("general.menu.tools.skin.default")), true,
                        setSkinDefault);
        skinMediumFont =
                new MenuItem(Util.menuHTML("img/icon/menu/skin_test.gif", Main.i18n("general.menu.tools.skin.mediumfont")), true,
                        setSkinMediumFont);
        skinBigFont =
                new MenuItem(Util.menuHTML("img/icon/menu/skin_test.gif", Main.i18n("general.menu.tools.skin.bigfont")), true,
                        setSkinBigFont);
        ...
        // Other tools options
        debugConsole =
                new MenuItem(Util.menuHTML("img/icon/menu/console.gif", Main.i18n("general.menu.tools.debug.console")), true,
                        setViewDebugConsole);
        debugConsole.addStyleName("okm-MainMenuItem");
        administration =
                new MenuItem(Util.menuHTML("img/icon/menu/administration.gif", Main.i18n("general.menu.tools.administration")), true,
                        showAdministration);
        ...
        userPreferences =
                new MenuItem(Util.menuHTML("img/icon/menu/user_preferences.gif", Main.i18n("general.menu.tools.user.preferences")), true,
                        setUserPreferences);
        ...
        // Submenu preferences
        preferences =
                new MenuItem(Util.menuHTML("img/icon/menu/preferences.gif", Main.i18n("general.menu.tools.preferences")), true,
                        subMenuPreferences);
        ...
        defaultHome =
                new MenuItem(Util.menuHTML("img/icon/actions/bookmark.gif", Main.i18n("general.menu.bookmark.default.home")), true,
                        setDefaultHome);
        defaultHome.addStyleName("okm-MainMenuItem");
        addBookmark =
                new MenuItem(Util.menuHTML("img/icon/actions/add_bookmark.gif", Main.i18n("general.menu.bookmark.add")), true,
                        addBookmarkOKM);
        addBookmark.addStyleName("okm-MainMenuItem");
        manageBookmark =
                new MenuItem(Util.menuHTML("img/icon/actions/bookmark_edit.gif", Main.i18n("general.menu.bookmark.edit")), true,
                        editBookmark);
        ...
        // Submenu help option
        help =
                new MenuItem(Util.menuHTML("img/icon/menu/help.gif", Util.windowOpen(Main.i18n("general.menu.help"), URI_HELP)), true,
                        nullExecute);
        help.addStyleName("okm-MainMenuItem");
        documentation =
                new MenuItem(Util.menuHTML("img/icon/menu/documentation.gif",
        ...
        bugReport =
                new MenuItem(Util.menuHTML("img/icon/menu/bugs.gif",
        ...
        supportRequest =
                new MenuItem(Util.menuHTML("img/icon/menu/support.gif",
        ...
        publicForum =
                new MenuItem(Util.menuHTML("img/icon/menu/forum.gif",
        ...
        versionChanges =
                new MenuItem(Util.menuHTML("img/icon/menu/brick.gif",
        ...
        projectWeb =
                new MenuItem(Util.menuHTML("img/icon/menu/home.gif",
        ...
        reportFormatPdf =
                new MenuItem(Util.menuHTML("img/icon/security/yes.gif", Main.i18n("general.menu.report.format.pdf")), true,
                        enablePdfReporFormat);
        reportFormatPdf.addStyleName("okm-MainMenuItem");
        reportFormatRtf =
                new MenuItem(Util.menuHTML("img/icon/security/no.gif", Main.i18n("general.menu.report.format.rtf")), true,
                        enableTextReporFormat);
        reportFormatRtf.addStyleName("okm-MainMenuItem");
        reportFormatRtf.addStyleName("okm-MenuItem-strike");
        reportFormatCsv =
                new MenuItem(Util.menuHTML("img/icon/security/no.gif", Main.i18n("general.menu.report.format.csv")), true,
        ...
        reportFormat =
                new MenuItem(Util.menuHTML("img/icon/menu/preferences.gif", Main.i18n("general.menu.report.format")), true,
                        subMenuReportFormat);
