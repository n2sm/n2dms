...
public class MainMenu extends Composite {
    ...
    public void evaluateMenuOptions() {
        ...
        for (final MenuItem item : templateMenuItems) {
            if (mainMenuOption.createFromTemplateOption) {
                enable(item);
            } else {
                disable(item);
     ...
     */
    public void setOptions(final ToolBarOption mainMenuOption) {
     ...
     * @param option
     */
    public void setAvailableOption(final GWTWorkspace workspace) {
        final GWTAvailableOption option = workspace.getAvailableOption();
        ...
        if (workspace.getReports().size() > 0) {
            ...
            for (final GWTReport report : workspace.getReports()) {
                final MenuItem reportMenuItem = new MenuItem(Util.menuHTML(
     ...
     * @param visible
     */
    public void setEditMenuVisible(final boolean visible) {
     ...
     * @param visible
     */
    public void setToolsMenuVisible(final boolean visible) {
     ...
     * @param visible
     */
    public void setBookmarkMenuVisible(final boolean visible) {
     ...
     * @param visible
     */
    public void setTemplatesMenuVisible(final boolean visible) {
     ...
     * @param visible
     */
    public void setHelpMenuVisible(final boolean visible) {
     ...
     * @param visible
     */
    public void setFileMenuVisible(final boolean visible) {
     ...
     * @param extension
     */
    public void addMenuExtension(final MenuItemExtension extension) {
     ...
     */
    public void initAvailableLanguage(final List<GWTLanguage> langs) {
        for (final GWTLanguage lang : langs) {
            final MenuItem menuItem = new MenuItem(Util.flagMenuHTML(
                    lang.getId(), lang.getName()), true, new Command() {
                @Override
                public void execute() {
                    ...
                    .getAllTemplates(new AsyncCallback<List<GWTDocument>>() {
                        ...
                        public void onSuccess(final List<GWTDocument> result) {
                            ...
                            for (final GWTDocument doc : result) {
                                final String[] paths = doc.getPath().split("/");
                                ...
                                final MenuItem docItem = new MenuItem(Util
                                        .menuHTML(
                                        ...
                                        new Command() {
                                            ...
                                            public void execute() {
                                                if (mainMenuOption.createFromTemplateOption) {
                                                    Main.get().templatePopup.reset(
                                                            doc,
                                                            Main.get().activeFolderTree
                                                                    .getActualPath(),
                                                            false);
                                                    Main.get().templatePopup
                                                            .center();
                                                }
                                            }
                                        });
     ...
     * createSubMenu
     */
    private void createSubMenu(final String parentFolderPath,
            final String fldName) {
        final MenuBar subMenuFolder = new MenuBar(true);
        subMenuFolder.setStyleName("okm-SubMenuBar");

        final MenuItem menuFolder = new MenuItem(Util.menuHTML(
     ...
     */
    public void startRefreshingMenus(final double scheduleTime) {
