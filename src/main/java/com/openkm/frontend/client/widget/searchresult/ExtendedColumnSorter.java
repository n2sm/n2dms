...
public class ExtendedColumnSorter extends ColumnSorter {
    ...
    private void sort(int column, boolean ascending) {
        ...
        Map<Integer, GWTQueryResult> data =
                new HashMap<Integer, GWTQueryResult>(Main.get().mainPanel.search.searchBrowser.searchResult.searchCompactResult.table.data);
            ...
            for (int i = 0; i < rows; i++) {
                ...
                case 2:
                    ...
                    if (((GWTQueryResult) data.get(Integer.parseInt(rowI[colDataIndex]))).getDocument() != null) {
                        ...
                        rowToOrder.setObject(((GWTQueryResult) data.get(Integer.parseInt(rowI[colDataIndex]))).getAttachment().getName()
                                .toLowerCase());
                ...
                case 3:
                    ...
                    if (((GWTQueryResult) data.get(Integer.parseInt(rowI[colDataIndex]))).getDocument() != null) {
                        ...
                        rowToOrder.setObject(new Double(((GWTQueryResult) data.get(Integer.parseInt(rowI[colDataIndex]))).getAttachment()
                                .getActualVersion().getSize()));
                    } else if (((GWTQueryResult) data.get(Integer.parseInt(rowI[colDataIndex]))).getFolder() != null) {
                ...
                case 4:
                    ...
                    if (((GWTQueryResult) data.get(Integer.parseInt(rowI[colDataIndex]))).getDocument() != null) {
                        ...
                        rowToOrder.setObject(((GWTQueryResult) data.get(Integer.parseInt(rowI[colDataIndex]))).getFolder().getCreated());
                    } else if (((GWTQueryResult) data.get(Integer.parseInt(rowI[colDataIndex]))).getMail() != null) {
                        rowToOrder.setObject(((GWTQueryResult) data.get(Integer.parseInt(rowI[colDataIndex]))).getMail().getReceivedDate());
                    }
                    rowToOrder.setDataId("" + i); // Actual position value
                    elementToOrder.add(rowToOrder);
                    break;
                ...
                case 16:
                    if (((GWTQueryResult) data.get(Integer.parseInt(rowI[colDataIndex]))).getDocument() != null) {
                        ...
                        rowToOrder.setObject(getExtraColumn(((GWTQueryResult) data.get(Integer.parseInt(rowI[colDataIndex]))).getFolder(),
                                correctedColumn));
                    } else if (((GWTQueryResult) data.get(Integer.parseInt(rowI[colDataIndex]))).getMail() != null) {
                        rowToOrder.setObject(getExtraColumn(((GWTQueryResult) data.get(Integer.parseInt(rowI[colDataIndex]))).getMail(),
                                correctedColumn));
                    }
                    rowToOrder.setDataId("" + i); // Actual position value
                    elementToOrder.add(rowToOrder);
