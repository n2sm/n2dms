...
public class KeywordsPopup extends DialogBox {
    ...
    public KeywordsPopup() {
        ...
        thesaurusImage.addClickHandler(new ClickHandler() {
            @Override
            public void onClick(ClickEvent event) {
                Main.get().mainPanel.desktop.navigator.thesaurusTree.thesaurusSelectPopup.show(ThesaurusSelectPopup.MASSIVE);
            }
        });
    ...
    public void removeKeyword(String keyword) {
        if (Main.get().mainPanel.desktop.browser.fileBrowser.isMassive()) {
            ...
            massiveService.removeKeyword(Main.get().mainPanel.desktop.browser.fileBrowser.getAllSelectedPaths(), keyword,
                    new AsyncCallback<Object>() {
                        @Override
                        public void onSuccess(Object result) {
