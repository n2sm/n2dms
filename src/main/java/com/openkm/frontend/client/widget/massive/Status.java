...
public class Status extends PopupPanel {
     ...
     */
    public void refresh() {
        if (flag_merge || flag_setCategories || flag_addKeywords || flag_addNotes || flag_removeCategories || flag_removeKeywords
                || flag_addPropertyGroup || flag_removePropertyGroup || flag_delete || flag_copy || flag_move || flag_omr || flag_convert
                || flag_lock || flag_unlock) {
