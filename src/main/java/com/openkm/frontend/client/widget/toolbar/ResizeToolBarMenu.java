...
public class ResizeToolBarMenu extends DialogBox {
    ...
    public ResizeToolBarMenu() {
        ...
        normalView =
                new MenuItem(Util.menuHTML("img/icon/actions/normal_size.png", Main.i18n("general.menu.resize.normal")), true,
                        new Command() {
                            @Override
                            public void execute() {
                                restoreToNormal();
        ...
        closeTreeView =
                new MenuItem(Util.menuHTML("img/icon/actions/close_three_size.png", Main.i18n("general.menu.resize.close.tree")), true,
                        new Command() {
                            @Override
                            public void execute() {
        ...
        closePropertiesView =
                new MenuItem(
                        Util.menuHTML("img/icon/actions/close_properties_size.png", Main.i18n("general.menu.resize.close.properties")),
                        true, new Command() {
                            @Override
                            public void execute() {
        ...
        expandTreeView =
                new MenuItem(Util.menuHTML("img/icon/actions/close_three_size.png", Main.i18n("general.menu.resize.expand.tree")), true,
                        new Command() {
                            @Override
                            public void execute() {
        ...
        expandFileBrowserView =
                new MenuItem(Util.menuHTML("img/icon/actions/filebrowser_size.png", Main.i18n("general.menu.resize.expand.filebrowser")),
                        true, new Command() {
                            @Override
                            public void execute() {
        ...
        expandPropertiesView =
                new MenuItem(Util.menuHTML("img/icon/actions/properties_size.png", Main.i18n("general.menu.resize.expand.properties")),
                        true, new Command() {
                            @Override
                            public void execute() {
    ...
    public void langRefresh() {
        ...
        closePropertiesView.setHTML(Util.menuHTML("img/icon/actions/close_Properties_size.png",
                Main.i18n("general.menu.resize.close.properties")));
        expandTreeView.setHTML(Util.menuHTML("img/icon/actions/expand_tree_size.png", Main.i18n("general.menu.resize.expand.tree")));
        expandFileBrowserView.setHTML(Util.menuHTML("img/icon/actions/filebrowser_size.png",
                Main.i18n("general.menu.resize.expand.filebrowser")));
        expandPropertiesView.setHTML(Util.menuHTML("img/icon/actions/properties_size.png",
                Main.i18n("general.menu.resize.expand.properties")));
    }
}