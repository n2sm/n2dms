...
public class NotifyPopup extends DialogBox {
    ...
    public void executeSendDocument(int type) {
        isMassive =
                (Main.get().mainPanel.desktop.browser.fileBrowser.isMassive() && Main.get().mainPanel.desktop.browser.fileBrowser.table
                        .getAllSelectedDocumentsUUIDs().size() > 0);
    ...
    public void executeForwardMail() {
        isMassive =
                (Main.get().mainPanel.desktop.browser.fileBrowser.isMassive() && Main.get().mainPanel.desktop.browser.fileBrowser.table
                        .getAllSelectedMailUUIDs().size() > 0);
