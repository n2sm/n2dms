...
public class HorizontalSplitLayoutExtended extends SplitLayoutPanel {
    ...
    public void onResize() {
        ...
        rightWidth =
                this.getOffsetWidth()
                        - Integer.parseInt(DOM.getStyleAttribute(DOM.getChild(this.getElement(), 3), "left").replace("px", "").trim());
        if (leftWidth < 0) {
            leftWidth = 0;
        }
        if (rightWidth < 0) {
    ...
    public int getOffsetHeight() {
        ...
        if (offsetHeight == 0 && DOM.getStyleAttribute(this.getElement(), "height") != null
                && !DOM.getStyleAttribute(this.getElement(), "height").isEmpty()) {
    ...
    public int getOffsetWidth() {
        ...
        if (offsetWidth == 0 && DOM.getStyleAttribute(this.getElement(), "width") != null
                && !DOM.getStyleAttribute(this.getElement(), "width").isEmpty()) {
