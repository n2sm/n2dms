...
public class HistorySearch extends Composite {
    ...
    public HistorySearch() {
        ...
        stackPanel.add(
                scrollSearchSavedPanel,
                Util.createHeaderHTML("img/icon/stackpanel/find.gif",
                        Main.i18n("leftpanel.label.stored.search")), true);
        stackPanel.add(
                scrollUserNewsSavedPanel,
                Util.createHeaderHTML("img/icon/news.gif",
                        Main.i18n("leftpanel.label.user.search")), true);
