...
public class TopPanel extends Composite {
    public static final int PANEL_HEIGHT = 55 + (Util.getUserAgent().equals(
            "gecko") ? 2 : 0);
    ...
    public TopPanel() {
        ...
        toolsPanel.setCellHorizontalAlignment(toolBar,
                HasHorizontalAlignment.ALIGN_LEFT);
        toolsPanel.setCellVerticalAlignment(tabWorkspace,
                HasVerticalAlignment.ALIGN_BOTTOM);
        toolsPanel.setCellHorizontalAlignment(tabWorkspace,
        ...
        */
        ...
        final Image logo = new Image("img/logo_n2sm_tiny.gif");
        horizontalPanelMenu.add(logo);
        horizontalPanelMenu.setCellHorizontalAlignment(uploadingPanel,
                HasHorizontalAlignment.ALIGN_RIGHT);
        horizontalPanelMenu.setCellVerticalAlignment(uploadingPanel,
        ...
        horizontalPanelMenu.setCellHorizontalAlignment(logo,
                HasHorizontalAlignment.ALIGN_RIGHT);
        horizontalPanelMenu.setCellVerticalAlignment(logo,
                HasVerticalAlignment.ALIGN_MIDDLE);
     ...
     * @param number
     */
    public void setPendingFilesToUpload(final int number) {
        this.number = number;
        uploadingPanel.setVisible(number > 0);
        pendingInfo.setVisible(number - 1 > 0);
        pendingInfo.setHTML(number - 1 + " "
                + Main.i18n("fileupload.upload.queued"));
    }
     ...
     * @param percentage
     */
    public void setPercentageUploading(final int percentage) {
        if (percentage == 0) {
    ...
    */
    ...
    public class ExtendedHorizontalPanel extends HorizontalPanel implements
            HasClickHandlers {
        /**
