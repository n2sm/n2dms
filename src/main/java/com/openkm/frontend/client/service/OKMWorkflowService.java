...
public interface OKMWorkflowService extends RemoteService {
    ...
    public void runProcessDefinition(String UUID, String name,
            List<GWTFormElement> formElements) throws OKMException;

    public List<GWTTaskInstance> findUserTaskInstances() throws OKMException;

    public Map<String, List<GWTFormElement>> getProcessDefinitionForms(double id)
            throws OKMException;

    public Map<String, List<GWTFormElement>> getProcessDefinitionFormsByName(
            String name) throws OKMException;
    ...
    public List<GWTProcessInstance> findProcessInstancesByNode(String uuid)
            throws OKMException;

    public List<GWTProcessInstanceLogEntry> findLogsByProcessInstance(
            int processInstanceId) throws OKMException;

    public GWTTaskInstance getUserTaskInstance(long taskInstanceId)
            throws OKMException;
}
