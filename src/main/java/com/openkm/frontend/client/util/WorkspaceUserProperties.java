...
public class WorkspaceUserProperties {
    ...
    final AsyncCallback<GWTWorkspace> callbackGetUserWorkspace = new AsyncCallback<GWTWorkspace>() {
        public void onSuccess(GWTWorkspace result) {
            ...
            Main.get().mainPanel.search.searchBrowser.searchResult.searchCompactResult.setProfileFileBrowser(workspace
                    .getProfileFileBrowser());
    ...
    public void setAvailableAction() {
        ...
        if (Main.get().workspaceUserProperties.getWorkspace().isStackMetadataVisible()) {
            Main.get().mainPanel.desktop.navigator.metadataTree.menuPopup.menu.setAvailableOption(workspace.getAvailableOption());
            Main.get().mainPanel.desktop.browser.fileBrowser.metadataMenuPopup.menu.setAvailableOption(workspace.getAvailableOption());
        }
        ...
        Main.get().mainPanel.search.searchBrowser.searchResult.searchCompactResult.menuPopup.menu.setAvailableOption(workspace
                .getAvailableOption());
