    ...
    public int compare(GWTObjectToOrder arg0, GWTObjectToOrder arg1) {
        if (arg0.getObject() == null && arg1.getObject() == null) {
            ...
            if (arg0.getObject() instanceof GWTTextArea) {
                ...
                return String.valueOf(((GWTSuggestBox) arg0.getObject()).getText()).compareTo(
                        String.valueOf(((GWTSuggestBox) arg1.getObject()).getText()));
            } else if (arg0.getObject() instanceof GWTCheckBox) {
                return String.valueOf(((GWTCheckBox) arg0.getObject()).getValue()).compareTo(
                        String.valueOf(((GWTCheckBox) arg1.getObject()).getValue()));
