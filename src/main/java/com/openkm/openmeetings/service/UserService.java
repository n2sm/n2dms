...
public class UserService {
    ...
    public static String loginUser() throws Exception {
        ...
        result =
                RestService.callMap(OpenMeetingsUtils.getOpenMeetingServerURL() + "/services/UserService/loginUser?SID=" + SID
                        + "&username=" + Config.OPENMEETINGS_USER + "&userpass=" + Config.OPENMEETINGS_CREDENTIALS, null);
     ...
     */
    public static String setUserObjectAndGenerateRoomHash(String SID, String username, String firstname, String lastname,
            String profilePictureUrl, String email, String externalUserId, String externalUserType, long room_id, int becomeModeratorAsInt,
            int showAudioVideoTestAsInt) throws Exception {
        String roomHash = null;
        String restURL =
                OpenMeetingsUtils.getOpenMeetingServerURL() + "/services/UserService/setUserObjectAndGenerateRoomHash?" + "SID=" + SID
                        ...
                        + externalUserType + "&room_id=" + String.valueOf(room_id) + "&becomeModeratorAsInt=" + becomeModeratorAsInt
     ...
     */
    public static String setUserObjectAndGenerateRoomHashByURL(String SID, String username, String firstname, String lastname,
            String profilePictureUrl, String email, String externalUserId, String externalUserType, long room_id, int becomeModeratorAsInt,
            int showAudioVideoTestAsInt) throws Exception {
        String roomHash = null;
        String restURL =
                OpenMeetingsUtils.getOpenMeetingServerURL() + "/services/UserService/setUserObjectAndGenerateRoomHashByURL?" + "SID=" + SID
                        + "&username=" + username + "&firstname=" + firstname + "&lastname=" + lastname + "&profilePictureUrl="
                        + profilePictureUrl + "&email=" + email + "&externalUserId=" + externalUserId + "&externalUserType="
                        + externalUserType + "&room_id=" + String.valueOf(room_id) + "&becomeModeratorAsInt=" + becomeModeratorAsInt
                        + "&showAudioVideoTestAsInt=" + showAudioVideoTestAsInt;
