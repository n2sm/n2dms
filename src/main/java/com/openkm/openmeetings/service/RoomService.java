...
public class RoomService {
    ...
    public static List<Room> getRoomsPublic(String SID, long roomType) throws Exception {
        ...
        String restURL =
                OpenMeetingsUtils.getOpenMeetingServerURL() + "/services/RoomService/getRoomsPublic?" + "SID=" + SID + "&roomtypes_id="
     ...
     */
    public static long addRoomWithModerationExternalTypeAndTopBarOption(String SID, String roomName, long roomType, String comment,
            long numberOfPartizipants, Boolean isPublic, Boolean appointment, Boolean demoRoom, Boolean isModeratedRoom,
            String externalRoomType, Boolean allowUserQuestions, Boolean isAudioOnly, Boolean waitForRecording, Boolean isAllowedRecording,
            Boolean hideTopBar) throws Exception {
        String roomId = "";
        String restURL =
                OpenMeetingsUtils.getOpenMeetingServerURL() + "/services/RoomService/addRoomWithModerationExternalTypeAndTopBarOption?"
                        + "SID=" + SID + "&name=" + roomName + "&roomtypes_id=" + String.valueOf(roomType) + "&comment=" + comment
                        ...
                        + "&waitForRecording=" + waitForRecording.toString() + "&allowRecording=" + isAllowedRecording.toString()
                        + "&hideTopBar=" + hideTopBar.toString();
     ...
     */
    public static List<Room> getRoomsWithCurrentUsersByListAndType(String SID, int start, int max, String orderBy, Boolean asc,
            String externalRoomType) throws Exception {
        List<Room> rooms = new ArrayList<Room>();
        String restURL =
                OpenMeetingsUtils.getOpenMeetingServerURL() + "/services/RoomService/getRoomsWithCurrentUsersByListAndType?" + "SID=" + SID
                        + "&start=" + String.valueOf(start) + "&max=" + String.valueOf(max) + "&orderby=" + orderBy + "&asc="
    ...
    public static Room getRoomById(String SID, long rooms_id) throws Exception {
        Room room = null;
        String restURL =
                OpenMeetingsUtils.getOpenMeetingServerURL() + "/services/RoomService/getRoomById?" + "SID=" + SID + "&rooms_id="
                        + String.valueOf(rooms_id);
        Map<String, Element> result = RestService.callMap(restURL, null);
    ...
    public static long deleteRoom(String SID, long rooms_id) throws Exception {
        String restURL =
                OpenMeetingsUtils.getOpenMeetingServerURL() + "/services/RoomService/deleteRoom?" + "SID=" + SID + "&rooms_id="
                        + String.valueOf(rooms_id);
        Map<String, Element> result = RestService.callMap(restURL, null);
     ...
     * @throws Exception
     */
    public static String sendInvitationHash(String SID, String username, String message, String baseurl, String email, String subject,
            Long room_id, String conferencedomain, Boolean isPasswordProtected, String invitationpass, Integer valid, String validFromDate,
            String validFromTime, String validToDate, String validToTime, Long languageId, Boolean sendMail) throws Exception {
        String restURL =
                OpenMeetingsUtils.getOpenMeetingServerURL() + "/services/RoomService/sendInvitationHash?" + "SID=" + SID + "&username="
                        + username + "&message=" + message + "&baseurl=" + baseurl + "&email=" + email + "&subject=" + subject
                        + "&room_id=" + room_id + "&conferencedomain=" + conferencedomain + "&isPasswordProtected="
                        + isPasswordProtected.toString() + "&invitationpass=" + invitationpass + "&valid=" + valid.toString()
                        + "&validFromDate=" + validFromDate + "&validFromTime=" + validFromTime + "&validToDate=" + validToDate
                        + "&validToTime=" + validToTime + "&language_id=" + languageId.toString() + "&sendMail=" + sendMail.toString();
        Map<String, Element> result = RestService.callMap(restURL, null);
