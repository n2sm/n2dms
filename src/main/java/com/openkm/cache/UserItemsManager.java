...
public class UserItemsManager {
    ...
    public static synchronized void refreshJcrUserItems(Session session) throws RepositoryException {
        ...
        try {
            String statement =
                    "/jcr:root/" + Repository.ROOT + "//element(*, okm:document)[okm:content/@okm:author='" + session.getUserID() + "']";
    ...
    public static synchronized void refreshDbUserItemsAs(String token) throws AccessDeniedException, RepositoryException {
        ...
        String[] bases =
                new String[] { Repository.ROOT, Repository.CATEGORIES, Repository.TEMPLATES, Repository.PERSONAL, Repository.MAIL,
                        Repository.TRASH };
